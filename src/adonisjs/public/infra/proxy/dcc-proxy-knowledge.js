...
DCC.component(
  ...
  'dcc-rest',
  {
    ...
    oas: {
      paths: {
        '{url-manager}/room/case/annotation': {
          'post': {
            operationId: 'case-annotate',
            parameters: [
              {name: 'url-manager',
...
DCC.component(
  ...
  'dcc-rest',
  {
    ...
    oas: {
      paths: {
        '{url-manager}/room/case/annotations': {
          'get': {
            operationId: 'case-annotations',
            parameters: [
              {name: 'url-manager',
...
DCC.component(
  ...
  'dcc-rest',
  {
    ...
    oas: {
      paths: {
        '{url-manager}/room/quest/annotation': {
          'post': {
            operationId: 'quest-annotate',
            parameters: [
              {name: 'url-manager',
...
DCC.component(
  ...
  'dcc-rest',
  {
    ...
    oas: {
      paths: {
        '{url-manager}/room/quest/annotations': {
          'get': {
            operationId: 'quest-annotations',
            parameters: [
              {name: 'url-manager',
