(function () {
  AuthorCellManager.instance.insertSource(
    ...
    [['empty', '_', { src: 'images/cell/cell-blue.svg', width: 25, height: 25, alt: 'vazio' }],
      ...
      ['herbivor1', 'h', { src: 'images/cell/fish-herbivor-01-right.svg', width: 25, height: 25, alt: 'herbívoro 1' }],
      ['carnivor1', 'c', { src: 'images/cell/fish-carnivor-01-right.svg', width: 25, height: 25, alt: 'carnívoro 1' }],
...
<dcc-cell-image type="h" label="herbivor1" image="images/cell/fish-herbivor-01-right.svg"></dcc-cell-image>
<dcc-cell-image type="c" label="carnivor1" image="images/cell/fish-carnivor-01-right.svg"></dcc-cell-image>
...
<div style="flex:48px; max-height:48px; display:flex; flex-direction:row; border:2px">
   ...
   <div style="flex:10%; max-width:48px; max-height:48px; margin-right:10px">
      <dcc-button label="Herbívoro 1" topic="type/herbivor1"
                   image="images/cell/fish-herbivor-01-right.svg">
      </dcc-button>
   </div>
   <div style="flex:10%; max-width:48px; max-height:48px; margin-right:10px">
      <dcc-button label="Herbívoro 1" topic="type/herbivor1" message="rotate:90"
                   image="images/cell/fish-herbivor-01-right.svg">
      </dcc-button>
   </div>
   <div style="flex:10%; max-width:48px; max-height:48px; margin-right:10px">
      <dcc-button label="Carnívoro 1" topic="type/carnivor1"
                   image="images/cell/fish-carnivor-01-right.svg">
      </dcc-button>
   </div>
   <div style="flex:10%; max-width:48px; max-height:48px; margin-right:10px">
      <dcc-button label="Carnívoro 1" topic="type/carnivor1" message="flip:h"
