 class labProgressManager {
  constructor() {
    ...
    this.labExpiration = {1:this.setDateToISO(hourExpiration(new Date('2023/09/16 GMT-0300'),23)), 2:this.setDateToISO(hourExpiration(new Date('2023/09/16 GMT-0300'),23)),
